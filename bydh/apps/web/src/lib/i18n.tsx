...
const translations = {
  en: {
    ...
    fieldOrder: 'Order',
    fieldNotes: 'Notes',
    fieldHouseType: 'House type',
    fieldHouseDescription: 'House details',
    typeNewLabel: 'New type name',
    buttonAdd: 'Add',
    buttonAddBuildStep: 'Add build step',
    buttonAddHouseType: 'Add house type',
    buildAddHouseTypeHint: 'Add house type (villa, 2 floors, basement, etc.)',
  ...
  he: {
    ...
    fieldOrder: 'סדר',
    fieldNotes: 'הערות',
    fieldHouseType: 'סוג הבית',
    fieldHouseDescription: 'פרטי הבית',
    typeNewLabel: 'שם סוג חדש',
    buttonAdd: 'הוסף',
    buttonAddBuildStep: 'הוסף שלב בנייה',
    buttonAddHouseType: 'הוסף סוג בית',
    buildAddHouseTypeHint: 'הוסיפו סוג בית (וילה, 2 קומות, מרתף ועוד)',
